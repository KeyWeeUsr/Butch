...
class PauseCommand(TestCase):
    def test_pause_help(self):
        ...
        from butch.commands import cmd_pause
        ...
        with patch("butch.commands.print_help") as prnt:
            cmd_pause(params=[Argument(value=PARAM_HELP)], ctx=ctx)
    ...
    def test_pause(self):
        ...
        with patch("builtins.input") as inp:
            cmd_pause(params=[Argument(value=dummy)], ctx=ctx)
